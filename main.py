...
# from prompts.project_prompts import register_project_prompts  # Temporarily disabled
...
project_membership_service = ProjectMembershipService(redmine)
...
register_project_tools(mcp, project_service, project_membership_service, issue_service)
